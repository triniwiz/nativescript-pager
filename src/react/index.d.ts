...
export declare class _Pager<P extends PagerComponentProps<E>, S extends PagerComponentState, E extends NativeScriptPager> extends RCTView<P, S, E> {
    ...
    }>, Exclude<keyof P, "items" | "onLoaded" | "children" | "forwardedRef" | "onPropertyChange" | "onUnloaded" | "onAndroidBackPressed" | "onShowingModally" | "onShownModally" | "onTap" | "onDoubleTap" | "onPinch" | "onPan" | "onSwipe" | "onRotation" | "onLongPress" | "onTouch" | "_debug">> & {
        items: P["items"];
        ref: P["forwardedRef"];
...
declare const Pager: React.ComponentType<OwnPropsWithoutForwardedRef & React.ClassAttributes<NativeScriptPager>>;
