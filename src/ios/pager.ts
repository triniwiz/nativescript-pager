...
export class Pager extends common.Pager {
    ...
    constructor() {
        ...
        sv.frame = CGRectMake(0, 0, sv.frame.size.width, sv.frame.size.height+40);
        sv.setNeedsLayout();
       // this._ios.parentViewController.
       // this._ios.view.frame = CGRectMake(0, 0, this.ios.frame.size.width, this.ios.frame.size.height+40);
    }
